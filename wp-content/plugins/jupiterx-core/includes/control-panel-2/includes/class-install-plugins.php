...
class JupiterX_Core_Control_Panel_Install_Plugins {
	...
	public function get_plugins_for_frontend() {
		...
		if ( version_compare( JUPITERX_VERSION, '2.0.0', '>=' ) ) {
			...
			$bundled_plugins['qi-addons-for-elementor'] = [
				'id' => 99997,
				'theme_name' => 'jupiterx',
				'name' => 'Qi Addons For Elementor',
				'headline' => 'Over 100 flexible widgets for Elementor',
				'slug' => 'qi-addons-for-elementor',
				'is_callable' => 'QiAddonsForElementor',
				'file_path' => 'qi-addons-for-elementor/class-qiaddonsforelementor.php',
				...
				'recommended' => false,
				'version' => '',
				'desc' => 'Qi Addons for Elementor Premium gives you a stunning selection of 100+ carefully desinged, comprehensive widgets. All desinged with ease of use and customizability in mind.',
				'source' => 'wp-repo',
				'install_url' => '',
				'activate_url' => '',
				'update_url' => '',
				'wp_activate_url' => jupiterx_core_get_wp_action_url( 'qi-addons-for-elementor/class-qiaddonsforelementor.php', 'activate' ),
			];
			...
			$bundled_plugins['artboard'] = [
				'id' => 99994,
				'theme_name' => 'jupiterx',
				'name' => 'artboard',
				'headline' => 'Design, animate and present in the browser',
				'slug' => 'artboard',
				'is_callable' => '',
				'file_path' => '',
				'basename' => '',
				...
				'recommended' => false,
				'version' => '',
				'desc' => 'Build beautiful designs fast in the browser. Use 10,000+ assets from vector to image, audio and video as well as premade templates and mockups to create whatever you want in the simplest way.',
				'source' => 'wp-repo',
				'install_url' => '',
				'activate_url' => '',
				'update_url' => '',
