		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'slide-left' => esc_html__( 'Slide Left', 'jupiterx-core' ),
					'slide-right' => esc_html__( 'Slide Right', 'jupiterx-core' ),
					'scale-up' => esc_html__( 'Scale Up', 'jupiterx-core' ),
					'scale-down' => esc_html__( 'Scale Down', 'jupiterx-core' ),
				],
	...
	protected function register_block_style() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} .raven-post .raven-post-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function register_overlay_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .content-layout-overlay .raven-post:hover .raven-post-image-overlay',
			]
		);
	...
	protected function register_title_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => '1',
				'selector' => '{{WRAPPER}} .raven-metro-item:not(.raven-posts-full-width) .raven-post-title',
				'condition' => [
					'general_layout' => 'metro',
				],
			]
		...
		$this->add_group_control(
			...
			[
				...
				'scheme' => '1',
				'selector' => '{{WRAPPER}} .raven-matrix-item:not(.raven-posts-full-width) .raven-post-title',
				'condition' => [
					'general_layout' => 'matrix',
				],
			]
